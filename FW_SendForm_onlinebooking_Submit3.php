...
// E-Mail
$recipient = "bookings@caerwentplayingfields.com"; // Address to deliver form to
...
$errorStrings = array(
	...
	4 => 'sendForm33188', // No real error message for this
);
...
if (($input_type == INPUT_POST && !empty($_POST['sendForm33188']) ||
	($input_type == INPUT_GET && !empty($_GET['sendForm33188']))))
{
	// Probably not
	appendError(4);
}
